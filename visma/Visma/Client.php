<?php
include_once(__DIR__."/SessionStorage.php");
include_once(__DIR__."/Config/Test.php");
include_once(__DIR__."/Config/Live.php");
/**
 *
 */
...
class Client
{
    ...
    public function __construct($secret, $id, $tokenStorage = null, $config = null, \OAuth2\Client $oauth2 = null)
    {
    ...
    public function getAuthCode()
    {
        ...
        $auth_url = $this->_oauth2->getAuthenticationUrl($this->_config->authEndpoint(), $this->_config->redirectUri(), $params);//print_r('Location: ' . $auth_url);
