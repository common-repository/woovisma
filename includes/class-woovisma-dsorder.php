<?php
class DSVismaOrder extends DSVisma
{
    ...
    public $OrderDate;//  (string): Format: YYYY-MM-DD
    ...
    public $Rows;//  (array[OrderRow], optional)
    ...
    public function __construct($Amount, $CustomerId, $CurrencyCode, $VatAmount, $RoundingsAmount, $InvoiceCity, $InvoiceCountryCode, $InvoiceCustomerName, $InvoicePostalCode, $EuThirdParty, $CustomerIsPrivatePerson, $OrderDate, $Status, $RotReducedInvoicingType, $ReverseChargeOnConstructionServices)
    {
        parent::__construct();
        ...
        $this->setRequiredField("OrderDate");
